...
DEVICE_PATH := device/rockchip/RG353P
...
TARGET_KERNEL_CONFIG := RG353P_defconfig
TARGET_KERNEL_SOURCE := kernel/rockchip/RG353P
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 75067392
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 75067392
